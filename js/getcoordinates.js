...
function getCoordinates() {
	d3.csv("data/Austin_Animal_Center_Intakes_Geocoding_1.csv")
		.then(intakes => {

			intakes.forEach((intake) => {
				geocoder = new google.maps.Geocoder();
				geocoder.geocode({ 'address': intake["Found Location"] }, function (results, status) {
					if (status == google.maps.GeocoderStatus.OK) {
						...
						// Add the new coordinates to the results object
